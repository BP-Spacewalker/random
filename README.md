...
[![Build Status](https://travis-ci.org/effolkronium/random.svg?branch=vs2013)](https://travis-ci.org/effolkronium/random)
[![Build status](https://ci.appveyor.com/api/projects/status/vq1kodqqxwx16rfv/branch/vs2013?svg=true)](https://ci.appveyor.com/project/effolkronium/random/branch/vs2013)
[![Coverage Status](https://coveralls.io/repos/github/effolkronium/random/badge.svg?branch=vs2013&unused=0)](https://coveralls.io/github/effolkronium/random?branch=vs2013&unused=0)
...
* Advantages
  ...
  * **Trivial integration**. All code consists of a single header file [`random.hpp`](https://github.com/effolkronium/random/blob/vs2013/include/effolkronium/random.hpp). That's it. No library, no subproject, no dependencies, no complex build system. The class is written in vanilla C++11. All in all, everything should require no adjustment of your compiler flags or project settings.
...
```
#### Manually
The single required source, file [`random.hpp`](https://github.com/effolkronium/random/blob/vs2013/include/effolkronium/random.hpp) is in the [`include/effolkronium`](https://github.com/effolkronium/random/tree/vs2013/include/effolkronium) directory.
#### Then
